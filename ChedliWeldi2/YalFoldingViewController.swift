...
class YalFoldingViewController: YALFoldingTabBarController ,YALTabBarDelegate{
    ...
    */
    ...
    func setupYALTabBarController() {
        ...
        let item3 = YALTabBarItem(itemImage: UIImage(named: "settings_icon"), leftItemImage: nil, rightItemImage: nil)
        let item4 = YALTabBarItem(itemImage: UIImage(named: "chats_icon"), leftItemImage: nil, rightItemImage: nil)
